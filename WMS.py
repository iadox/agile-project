...
def merchendise(v,merch):
    ...
    if v == 0:
      ...
      remove_btn = HoverButton(content , text= '-' ,bg='#fb091d',activebackground='#baac41', fg='black' ,height=1,width=3, font=("Times New Roman", 13,'bold') , command= lambda:remove_item(items_list,Warehouse_items_list,Customer_items_list))
